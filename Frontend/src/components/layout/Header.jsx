...
const Header = () => {
  ...
  return (
    <header className="bg-light-200/95 dark:bg-dark-100/95 backdrop-blur-md border-b border-gray-300 dark:border-dark-400 sticky top-0 z-50 py-4 transition-colors duration-300">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center">
          {/* Logo Section */}
          <div className="flex flex-col">
            <h1 className="text-gray-900 dark:text-white text-lg sm:text-xl lg:text-2xl font-semibold">
              Marlon Munoz
            </h1>
          ...
          <div className="md:hidden flex items-center gap-2">
            ...
            <button
              ...
              className="p-2 rounded-lg text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-200 dark:hover:bg-white/10 transition-colors"
            >
        ...
        {/* Mobile Navigation */}
        {isMobileMenuOpen && (
          <nav className="md:hidden mt-4 pb-4 border-t border-gray-300 dark:border-dark-400/50">
